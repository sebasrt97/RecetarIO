        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded p-4 space-y-4">
                ...
                <div class="text-sm text-gray-800 dark:text-gray-200 space-y-2">
                    ...
                    <p><span class="font-semibold">Coste Bruto Total:</span> <?php echo e(number_format($receta->getCostebrutoTotal(),2,',','.')); ?> €</p>
                    <p><span class="font-semibold">Coste Neto Total:</span> <?php echo e(number_format($receta->getCosteNetoTotal(),2,',','.')); ?> €</p>
                    <p><span class="font-semibold">Coste Porcion:</span> <?php echo e(number_format($receta->getCostePorPorcion(),2,',','.')); ?> €</p>
                    <p><span class="font-semibold">Coste Neto Total:</span> <?php echo e(number_format($receta->getCosteNetoTotal(),2,',','.')); ?> €</p>
                    <p><span class="font-semibold">Precio Venta Por Porcion:</span> <?php echo e(number_format($receta->getPrecioVentaPorPorcion(),2,',','.')); ?> €</p>
                </div>
