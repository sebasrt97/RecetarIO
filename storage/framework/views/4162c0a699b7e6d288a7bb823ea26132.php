<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('Una vez borres la cuenta, se eliminará todos los datos correspondientes. Antes de elimnar la cuenta descargue todas sus recetas, escandallos ...')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('Borrar si o si ')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                <?php echo e(__('¿Quieres borrar la cuenta?')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Una vez borres la cuenta, se eliminará todos los datos correspondientes.')); ?>
