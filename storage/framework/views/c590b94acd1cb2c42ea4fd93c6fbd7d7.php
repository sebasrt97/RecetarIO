        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('recetas.index')); ?>" class="flex items-center"> <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
...
<?php endif; ?>
                        <span class="ms-3 text-lg font-semibold text-gray-800 dark:text-gray-200">RecetarIO</span>
                    </a>
                </div>
            </div>
