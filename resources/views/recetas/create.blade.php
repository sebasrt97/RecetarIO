    ...
    <div class="py-4">
        <div class="max-w-xl mx-auto px-4">
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded p-4">
                <form id="receta-form" method="POST" action="{{ route('recetas.store') }}" enctype="multipart/form-ingredienteDato" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <div id="ingredientes-ingredienteContenedor"></div>
                    ...
                    <div>
                        ...
                        <input type="number" id="margen_beneficio" name="margen_beneficio" value="{{ old('margen_beneficio') }}" step="0.01" min="0"
                               class="w-full border border-gray-300 dark:border-gray-600 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-white">
