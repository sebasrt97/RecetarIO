                ...
                <form id="receta-form" method="POST" action="{{ route('recetas.update', $receta) }}" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="instrucciones" name="instrucciones" required
                                  class="w-full border border-gray-300 dark:border-gray-600 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-white">{{ old('instrucciones', implode("\n", $receta->instrucciones ?? [])) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="ingredientes" name="ingredientes"
                                  class="w-full border border-gray-300 dark:border-gray-600 px-2 py-1 rounded text-sm dark:bg-gray-800 dark:text-white">{{ old('ingredientes', implode("\n", $receta->ingredientes ?? [])) }}</textarea>
